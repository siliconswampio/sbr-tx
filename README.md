...
`npm install https://github.com/siliconswampio/sbr-tx.git`
...
The `Transaction` constructor receives a parameter of an [`@sbr/common`](https://github.com/ethereumjs/ethereumjs-monorepo/blob/master/packages/common) object that lets you specify the chain and hardfork to be used. The chain defaults to `mainnet`. 
