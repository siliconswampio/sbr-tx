...
var BaseTransaction = /** @class */ (function () {
    function BaseTransaction(txData, txOptions) {
        ...
        var toB = sbr_util_1.toBuffer(to === '' ? '0x' : to);
        var vB = sbr_util_1.toBuffer(v === '' ? '0x' : v);
        var rB = sbr_util_1.toBuffer(r === '' ? '0x' : r);
        var sB = sbr_util_1.toBuffer(s === '' ? '0x' : s);
    ...
    BaseTransaction.prototype.sign = function (privateKey) {
        ...
        var _a = sbr_util_1.ecsign(msgHash, privateKey), v = _a.v, r = _a.r, s = _a.s;
